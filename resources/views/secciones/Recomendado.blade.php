...
<div class="px-20 flex flex-col conte-reco">
    ...
    <div class="px-20 gap-10 flex justify-start flex-wrap p-2 py-5 mb-5 contenedor-productos">
        @if ($recomendados->count() > 0)
            ...
            @endforeach
        @else
        <div class="w-full flex justify-center items-center sinreco" style="height: 60vh;">
            <h1 class="text-3xl font-semibold text-gray-500">No hay productos recomendados aun</h1>
        </div>
        @endif
    </div>
</div>
