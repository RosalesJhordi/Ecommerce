...
@section('contenido')
<h1 class="text-4xl text-blue-700 py-5 px-20 h1-pedido">Pedidos</h1>
<div class="px-20 flex gap-10 flex-wrap h-screen divpedidos">
    @if (count($pedido) > 0)
        @foreach ($pedido as $pedidos)
            <div class="border p-2 flex justify-between w-96 h-60 divpedido">
                <div class="w-1/2 h-full flex  flex-col relative">
                    ...
                    <a href="{{route('Cancelar',$pedidos->id)}}" class="absolute bottom-0 m-auto bg-red-500 p-1 rounded-md text-center w-1/2 text-white">Cancelar</a>
                </div>
