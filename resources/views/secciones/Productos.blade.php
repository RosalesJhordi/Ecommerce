...
@section('contenido')
<h1 class="px-20 text-sm font-semibold w-full mt-5 uppercase catego">Categorias</h1>
<div class="flex justify-start flex-wrap px-20 items-center py-1 gap-5 cat">
    @foreach ($categorias as $categoria)
        <form action="{{ route('Filtrar') }}" method="POST" class="text-md font-bold hover:text-blue-700 cursor-pointer">
            @csrf
...
<h1 class=" px-20 uppercase text-2xl font-extrabold font-mono text-blue-900 h1-productos">Productos Resientes</h1>
